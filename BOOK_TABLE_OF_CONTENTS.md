...
#### 9장: Flutter 시작하기 - 개념과 설치 가이드
---

#### 10장: Flutter 기초와 업무 앱 입문
...
| **3부: Flutter 앱** | 9-11장 | 8개 | 업무용 모바일 앱 |
| **총합** | **11장** | **36개** | 웹 → 자동화 → 앱 완성 |
...
3부: 손 안의 마법 - Flutter로 앱의 세계 (9-11장) - 8개
   ├─ 9장: Flutter 시작하기 - 개념과 설치
   ├─ 10장: [따라하기] Flutter 기초 (4개)
        └─ 첫 앱, Todo, 출퇴근, 체크리스트
   └─ 11장: 실전 업무용 Flutter 앱 (4개)
